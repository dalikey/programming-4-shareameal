...
(1,'Mariëtte','van den Dullemen',1,'m.vandullemen@server.nl','$2b$10$XZeO6dHkBY6ONcvv7zOIcuLW8ngiM2VFoO5tPOI2H2aLq02x9sYsm','','','',''),
(2,'John','Doe',1,'j.doe@server.com','$2b$10$SgtDwpZJ83ByfDZR0F.hk.1AFiLccVoceeq3tmfVPVbtvI2Oah43m','06 12425475','editor,guest','',''),
(3,'Herman','Huizinga',1,'h.huizinga@server.nl','$2b$10$BN5o8fLDFvn883YGKJ07wuT0jvXDsSdgklpToAcNJJmdit03n9TUe','06-12345678','editor,guest','',''),
(4,'Marieke','Van Dam',0,'m.vandam@server.nl','$2b$10$ulGLUDWpRuNXa8eICbCYROcONYbmDkLIxhYpBLbw8C1gcR8MJkXPG','06-12345678','editor,guest','',''),
(5,'Henk','Tank',1,'h.tank@server.com','$2b$10$pxb32zzbDBMgXRTgBMsms.ZaN3/ciVktU5mLGoE5ynmLBnMtlcEve','06 12425495','editor,guest','','');
